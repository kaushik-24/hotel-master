...
class HeroController {
    async getHero(req, res) {
        try {
            const response = await hero_services_1.default.getHero();
    ...
    async createHero(req, res) {
        try {
            const response = await hero_services_1.default.createHero(req.body, req.file);
    ...
    async updateHero(req, res) {
        try {
            const response = await hero_services_1.default.updateHero(req.body, req.file);
            res.status(statusCode_1.StatusCodes.SUCCESS).json({
                success: true,
