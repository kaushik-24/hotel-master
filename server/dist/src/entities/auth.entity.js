...
const enum_1 = require("../constant/enum"); // Assuming ROLE is the updated enum
...
__decorate([
    (0, typeorm_1.OneToOne)(() => details_entity_1.AuthDetails, (details) => details.auth, { cascade: true }),
    __metadata("design:type", details_entity_1.AuthDetails)
], Auth.prototype, "details", void 0);
__decorate([
...
], Auth.prototype, "otpVerified", void 0);
