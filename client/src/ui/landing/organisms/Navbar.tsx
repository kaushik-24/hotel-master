...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full h-[90px] px-14 flex justify-between items-center z-50 bg-gradient-to-b from-black/50 to-transparent">
            <Logo />
            ...
            {isMenuOpen && (
                <div className="fixed top-0 right-0 w-full md:w-1/2 h-full flex flex-col items-center bg-split-gradient z-10 overflow-y-auto">
